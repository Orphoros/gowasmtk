...
The GoWasmTK library is currently in development and not yet ready for production use.
...
Currently, due to the early stage of development, only the latest version of GoWasmTK is supported with security updates.
